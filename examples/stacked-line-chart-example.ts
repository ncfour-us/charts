...
import { StackedLineChart } from '@ncfour-us/charts';
...
const myChart = new StackedLineChart({
...
await myChart.writePngFile('my-stackedlinechart.png');

await myChart.writeJpegFile('my-stackedlinechart.jpg');

await myChart.writeSvgFile('my-stackedlinechart.svg');
...
<div class="row-container">
  ...
  <div class="row-item">
    ...
    <img src="my-stackedlinechart.png">
  </div>
</div>`;
...
<div class="row-container">
  ...
  <div class="row-item">
    ...
    <img src="my-stackedlinechart.jpg">
  </div>
</div>`;
...
<div class="row-container">
  ...
  <div class="row-item">
    ...
    <img src="my-stackedlinechart.svg">
  </div>
</div>`;

await myChart.writeHtmlFile('my-stackedlinechart.html', 'Stacked Line Chart Example formats', [
  styleSection,
  htmlBuffer,
  svgDiv,
  pngDiv,
